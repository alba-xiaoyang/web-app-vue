      ...
      <div class="footer-links">
        ...
        <ul>
          <div class="column-1">
            ...
            <li><a href="https://livitt-landing.netlify.app/#about">Sobre la app</a></li>
            <!-- Agregar hash para sección -->
            <li><a href="https://livitt-landing.netlify.app/#about-us">Equipo</a></li>
            <!-- Agregar hash para sección -->
          </div>
          <div class="column-2">
...
.footer-bottom {
  ...
  padding-top: 10px;
  font-size: 12px;
  border-top: 1px solid var(--grisoscuropastel);
}
