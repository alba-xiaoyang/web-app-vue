  ...
  <div class="list-task-done">
    ...
    <ul>
      <li v-for="task in tasksDone" :key="task.id">
        <div class="task">
          <h3 class="subtitle"><i class="fas fa-clipboard-list"></i>
            <strong> Tarea:</strong> {{task.task}}</h3>
          <div class="data">
            <p>{{task.user}}</p>
...
.list-task-done {
  ...
  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.15), 0 2px 16px rgba(0, 0, 0, 0.1); /* Sombra más intensa */
}
...
button:hover {
  ...
  box-shadow: 0 6px 12px rgba(0, 0, 0, 0.2), 0 4px 24px rgba(0, 0, 0, 0.15); /* Sombra más pronunciada */
